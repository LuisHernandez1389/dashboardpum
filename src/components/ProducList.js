...
function ProductList({
            ...
            <tr>
              ...
              <th scope="col"><div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#importModal">Importar</button></li>
                  <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exportModal">Exportar</button></li>
                </ul>
              </div></th>
          ...
          <tbody>
            {displayProducts.map((product) => (
              <tr key={product.id}>
                ...
                <td>{product.descripcion.substring(0, 20)}{product.descripcion.length > 20 ? '...' : ''}</td>
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-5" id="importModalLabel">Importar Producto</h1>
        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="modal-body">
        <form>
          <div className="mb-3">
            <label htmlFor="importFile" className="form-label">Seleccionar archivo</label>
            <input type="file" accept=".xlsx" onChange={handleImportExcel} />
          </div>
          {/* Agrega más campos según sea necesario para la importación */}
...
<div className="modal fade" id="exportModal" tabIndex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-5" id="exportModalLabel">Exportar Producto</h1>
        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="modal-body">
        <p>¿Estás seguro de que quieres exportar este producto?</p>
        {/* Agrega más detalles sobre la exportación si es necesario */}
      </div>
      <div className="modal-footer">
        <button type="button"  onClick={exportToExcel} className="btn btn-primary">Exportar</button>
